				...
				<div class="buyer-info row">
					...
					<div class="col-xl-7 block-left">
						...
						<div class="form">
							...
							<div class="form-group">
								<div class="input-container">
									<input id="mobile" type="tel" class="form-control" placeholder="Số điện thoại" name="shipping_phone" value="{{ old('shipping_phone') }}" required=""
							...
							<div class="form-group">
								<div class="input-container">
									<input type="email" class="form-control" placeholder="Email" name="shipping_email" value="{{ old('shipping_email') }}" required=""
									oninvalid="this.setCustomValidity('Nhập email của bạn.')" 
									onchange="this.setCustomValidity('')">
								</div>
							</div>
							<div class="form-group">
...
@endif
   ...
   //Cập nhật tự động giá theo số lượng
