                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Type</label>
                                      <select name="category_product_type" class="form-control input-sm m-bot15">
                                            <option value="0" {{$edit_value->category_type === 0 ? 'selected' :''}}>Sản Phẩm</option>
                                            <option value="1" {{$edit_value->category_type === 1 ? 'selected' :''}}>Phụ Kiện</option>
                                    </select>
                                </div>
                                <button type="submit" name="update_category_product" class="btn btn-info">Cập nhật danh mục</button>
                                
                                <a href="{{asset('/all-category-product')}}"><i class="fa fa-arrow-right"></i> <span>Quay Về trang quản lý sản phẩm</span></a>
                                </form>
                            </div>
                            @endforeach
                        </div>
