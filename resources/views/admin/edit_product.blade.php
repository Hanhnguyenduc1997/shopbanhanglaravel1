                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Slug</label>
                                      <select name="product_slug" class="form-control input-sm m-bot15">
                                        @foreach($cate_product as $key => $cate)
                                            @if($cate->slug_category_product==$pro->product_slug)
                                            <option selected value="{{$cate->slug_category_product}}">{{$cate->slug_category_product}}</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$pro->product_price_discount}}" name="product_price_discount" class="form-control" id="exampleInputEmail1" >
                                </div>
                                  <div class="form-group">
